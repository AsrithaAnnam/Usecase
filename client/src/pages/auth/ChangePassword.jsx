      ...
      <div className="glass w-full max-w-md rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input {...register('currentPassword')} type="password" className="glass-input" />
          </div>
          <div>
            <label className="mb-1 block text-sm text-white/70">New Password</label>
            <input {...register('newPassword')} type="password" className="glass-input" />
          ...
          <div>
            ...
            <input {...register('confirmPassword')} type="password" className="glass-input" />
